declare const _default: () => {
    form: import('vue').Ref<({
        ...
        $data: {};
        $props: Partial<{}> & Omit<{
            readonly onSubmit?: ((model: import('..').FormSubmitPayload<any>, actions: import('..').FormActions) => any) | undefined;
        ...
        $parent: import('vue').ComponentPublicInstance | null;
        $host: Element | null;
        $emit: (event: "submit", model: import('..').FormSubmitPayload<any>, actions: import('..').FormActions) => void;
        $el: any;
        $options: import('vue').ComponentOptionsBase<Readonly<{}> & Readonly<{
            onSubmit?: ((model: import('..').FormSubmitPayload<any>, actions: import('..').FormActions) => any) | undefined;
        }>, {
            submit: () => void;
            validate: () => Promise<any>;
            resetForm: () => void;
        }, {}, {}, {}, import('vue').ComponentOptionsMixin, import('vue').ComponentOptionsMixin, {} & {
            submit: (model: import('..').FormSubmitPayload<any>, actions: import('..').FormActions) => any;
        ...
        onSubmit?: ((model: import('..').FormSubmitPayload<any>, actions: import('..').FormActions) => any) | undefined;
    }>, "submit" | "validate" | "resetForm"> & import('vue').ShallowUnwrapRef<{
        submit: () => void;
        validate: () => Promise<any>;
        resetForm: () => void;
    }> & {} & import('vue').ComponentCustomProperties & {} & {
